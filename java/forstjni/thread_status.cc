...
#include "include/org_forstdb_ThreadStatus.h"
#include "portal.h"
 ...
 */
jstring Java_org_forstdb_ThreadStatus_getThreadTypeName(
 ...
 * Signature: (B)Ljava/lang/String;
 */
jstring Java_org_forstdb_ThreadStatus_getOperationName(
 ...
 */
jstring Java_org_forstdb_ThreadStatus_microsToStringNative(JNIEnv* env, jclass,
                                                           jlong jmicros) {
 ...
 * Signature: (B)Ljava/lang/String;
 */
jstring Java_org_forstdb_ThreadStatus_getOperationStageName(
 ...
 */
jobject Java_org_forstdb_ThreadStatus_interpretOperationProperties(
    JNIEnv* env, jclass, jbyte joperation_type_value,
 ...
 * Signature: (B)Ljava/lang/String;
 */
jstring Java_org_forstdb_ThreadStatus_getStateName(JNIEnv* env, jclass,
