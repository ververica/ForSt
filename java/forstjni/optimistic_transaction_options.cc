...
#include "include/org_forstdb_OptimisticTransactionOptions.h"
 ...
 * Signature: (J)Z
 */
jboolean Java_org_forstdb_OptimisticTransactionOptions_isSetSnapshot(
 ...
 * Signature: (JZ)V
 */
void Java_org_forstdb_OptimisticTransactionOptions_setSetSnapshot(
 ...
 * Signature: (JJ)V
 */
void Java_org_forstdb_OptimisticTransactionOptions_setComparator(
    JNIEnv* /*env*/, jobject /*jobj*/, jlong jhandle,
 ...
 * Signature: (J)V
 */
void Java_org_forstdb_OptimisticTransactionOptions_disposeInternal(
    JNIEnv* /*env*/, jobject /*jobj*/, jlong jhandle) {
