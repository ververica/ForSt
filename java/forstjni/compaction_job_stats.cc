...
#include "include/org_forstdb_CompactionJobStats.h"
 ...
 * Signature: ()J
 */
jlong Java_org_forstdb_CompactionJobStats_newCompactionJobStats(JNIEnv*,
                                                                jclass) {
 ...
 * Signature: (J)V
 */
void Java_org_forstdb_CompactionJobStats_disposeInternal(JNIEnv*, jobject,
                                                         jlong jhandle) {
 ...
 * Signature: (J)V
 */
void Java_org_forstdb_CompactionJobStats_reset(JNIEnv*, jclass, jlong jhandle) {
  auto* compact_job_stats =
      reinterpret_cast<ROCKSDB_NAMESPACE::CompactionJobStats*>(jhandle);
 ...
 * Signature: (JJ)V
 */
void Java_org_forstdb_CompactionJobStats_add(JNIEnv*, jclass, jlong jhandle,
                                             jlong jother_handle) {
  auto* compact_job_stats =
      reinterpret_cast<ROCKSDB_NAMESPACE::CompactionJobStats*>(jhandle);
 ...
 * Signature: (J)J
 */
jlong Java_org_forstdb_CompactionJobStats_elapsedMicros(JNIEnv*, jclass,
                                                        jlong jhandle) {
  auto* compact_job_stats =
      reinterpret_cast<ROCKSDB_NAMESPACE::CompactionJobStats*>(jhandle);
 ...
 * Signature: (J)J
 */
jlong Java_org_forstdb_CompactionJobStats_numInputRecords(JNIEnv*, jclass,
                                                          jlong jhandle) {
  auto* compact_job_stats =
      reinterpret_cast<ROCKSDB_NAMESPACE::CompactionJobStats*>(jhandle);
 ...
 * Signature: (J)J
 */
jlong Java_org_forstdb_CompactionJobStats_numInputFiles(JNIEnv*, jclass,
                                                        jlong jhandle) {
  auto* compact_job_stats =
      reinterpret_cast<ROCKSDB_NAMESPACE::CompactionJobStats*>(jhandle);
 ...
 * Signature: (J)J
 */
jlong Java_org_forstdb_CompactionJobStats_numOutputRecords(JNIEnv*, jclass,
                                                           jlong jhandle) {
  auto* compact_job_stats =
      reinterpret_cast<ROCKSDB_NAMESPACE::CompactionJobStats*>(jhandle);
 ...
 * Signature: (J)J
 */
jlong Java_org_forstdb_CompactionJobStats_numOutputFiles(JNIEnv*, jclass,
                                                         jlong jhandle) {
  auto* compact_job_stats =
      reinterpret_cast<ROCKSDB_NAMESPACE::CompactionJobStats*>(jhandle);
 ...
 * Signature: (J)Z
 */
jboolean Java_org_forstdb_CompactionJobStats_isManualCompaction(JNIEnv*, jclass,
                                                                jlong jhandle) {
  auto* compact_job_stats =
      reinterpret_cast<ROCKSDB_NAMESPACE::CompactionJobStats*>(jhandle);
 ...
 * Signature: (J)J
 */
jlong Java_org_forstdb_CompactionJobStats_totalInputBytes(JNIEnv*, jclass,
                                                          jlong jhandle) {
  auto* compact_job_stats =
      reinterpret_cast<ROCKSDB_NAMESPACE::CompactionJobStats*>(jhandle);
 ...
 * Signature: (J)J
 */
jlong Java_org_forstdb_CompactionJobStats_totalOutputBytes(JNIEnv*, jclass,
                                                           jlong jhandle) {
  auto* compact_job_stats =
      reinterpret_cast<ROCKSDB_NAMESPACE::CompactionJobStats*>(jhandle);
 ...
 * Signature: (J)J
 */
jlong Java_org_forstdb_CompactionJobStats_numRecordsReplaced(JNIEnv*, jclass,
                                                             jlong jhandle) {
  auto* compact_job_stats =
      reinterpret_cast<ROCKSDB_NAMESPACE::CompactionJobStats*>(jhandle);
 ...
 * Signature: (J)J
 */
jlong Java_org_forstdb_CompactionJobStats_totalInputRawKeyBytes(JNIEnv*, jclass,
                                                                jlong jhandle) {
  auto* compact_job_stats =
      reinterpret_cast<ROCKSDB_NAMESPACE::CompactionJobStats*>(jhandle);
 ...
 * Signature: (J)J
 */
jlong Java_org_forstdb_CompactionJobStats_totalInputRawValueBytes(
    JNIEnv*, jclass, jlong jhandle) {
  auto* compact_job_stats =
      reinterpret_cast<ROCKSDB_NAMESPACE::CompactionJobStats*>(jhandle);
 ...
 * Signature: (J)J
 */
jlong Java_org_forstdb_CompactionJobStats_numInputDeletionRecords(
    JNIEnv*, jclass, jlong jhandle) {
  auto* compact_job_stats =
      reinterpret_cast<ROCKSDB_NAMESPACE::CompactionJobStats*>(jhandle);
 ...
 * Signature: (J)J
 */
jlong Java_org_forstdb_CompactionJobStats_numExpiredDeletionRecords(
    JNIEnv*, jclass, jlong jhandle) {
  auto* compact_job_stats =
      reinterpret_cast<ROCKSDB_NAMESPACE::CompactionJobStats*>(jhandle);
 ...
 * Signature: (J)J
 */
jlong Java_org_forstdb_CompactionJobStats_numCorruptKeys(JNIEnv*, jclass,
                                                         jlong jhandle) {
  auto* compact_job_stats =
      reinterpret_cast<ROCKSDB_NAMESPACE::CompactionJobStats*>(jhandle);
 ...
 * Signature: (J)J
 */
jlong Java_org_forstdb_CompactionJobStats_fileWriteNanos(JNIEnv*, jclass,
                                                         jlong jhandle) {
  auto* compact_job_stats =
      reinterpret_cast<ROCKSDB_NAMESPACE::CompactionJobStats*>(jhandle);
 ...
 * Signature: (J)J
 */
jlong Java_org_forstdb_CompactionJobStats_fileRangeSyncNanos(JNIEnv*, jclass,
                                                             jlong jhandle) {
  auto* compact_job_stats =
      reinterpret_cast<ROCKSDB_NAMESPACE::CompactionJobStats*>(jhandle);
 ...
 * Signature: (J)J
 */
jlong Java_org_forstdb_CompactionJobStats_fileFsyncNanos(JNIEnv*, jclass,
                                                         jlong jhandle) {
  auto* compact_job_stats =
      reinterpret_cast<ROCKSDB_NAMESPACE::CompactionJobStats*>(jhandle);
 ...
 * Signature: (J)J
 */
jlong Java_org_forstdb_CompactionJobStats_filePrepareWriteNanos(JNIEnv*, jclass,
                                                                jlong jhandle) {
  auto* compact_job_stats =
      reinterpret_cast<ROCKSDB_NAMESPACE::CompactionJobStats*>(jhandle);
 ...
 * Signature: (J)[B
 */
jbyteArray Java_org_forstdb_CompactionJobStats_smallestOutputKeyPrefix(
 ...
 * Signature: (J)[B
 */
jbyteArray Java_org_forstdb_CompactionJobStats_largestOutputKeyPrefix(
    JNIEnv* env, jclass, jlong jhandle) {
  auto* compact_job_stats =
      reinterpret_cast<ROCKSDB_NAMESPACE::CompactionJobStats*>(jhandle);
  return ROCKSDB_NAMESPACE::JniUtil::copyBytes(
 ...
 * Signature: (J)J
 */
jlong Java_org_forstdb_CompactionJobStats_numSingleDelFallthru(JNIEnv*, jclass,
                                                               jlong jhandle) {
  auto* compact_job_stats =
      reinterpret_cast<ROCKSDB_NAMESPACE::CompactionJobStats*>(jhandle);
 ...
 * Signature: (J)J
 */
jlong Java_org_forstdb_CompactionJobStats_numSingleDelMismatch(JNIEnv*, jclass,
                                                               jlong jhandle) {
  auto* compact_job_stats =
      reinterpret_cast<ROCKSDB_NAMESPACE::CompactionJobStats*>(jhandle);
