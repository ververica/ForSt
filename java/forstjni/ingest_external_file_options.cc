...
#include "include/org_forstdb_IngestExternalFileOptions.h"
 ...
 * Signature: ()J
 */
jlong Java_org_forstdb_IngestExternalFileOptions_newIngestExternalFileOptions__(
    JNIEnv*, jclass) {
 ...
 * Signature: (J)Z
 */
jboolean Java_org_forstdb_IngestExternalFileOptions_moveFiles(JNIEnv*, jobject,
                                                              jlong jhandle) {
  auto* options =
 ...
 * Signature: (JZ)V
 */
void Java_org_forstdb_IngestExternalFileOptions_setMoveFiles(
 ...
 * Signature: (J)Z
 */
jboolean Java_org_forstdb_IngestExternalFileOptions_snapshotConsistency(
 ...
 * Signature: (J)Z
 */
jboolean Java_org_forstdb_IngestExternalFileOptions_allowGlobalSeqNo(
    JNIEnv*, jobject, jlong jhandle) {
  auto* options =
      reinterpret_cast<ROCKSDB_NAMESPACE::IngestExternalFileOptions*>(jhandle);
 ...
 * Signature: (J)Z
 */
jboolean Java_org_forstdb_IngestExternalFileOptions_allowBlockingFlush(
    JNIEnv*, jobject, jlong jhandle) {
  auto* options =
      reinterpret_cast<ROCKSDB_NAMESPACE::IngestExternalFileOptions*>(jhandle);
 ...
 * Signature: (JZ)V
 */
void Java_org_forstdb_IngestExternalFileOptions_setAllowBlockingFlush(
 ...
 * Signature: (JZ)V
 */
void Java_org_forstdb_IngestExternalFileOptions_setIngestBehind(
...
Java_org_forstdb_IngestExternalFileOptions_writeGlobalSeqno(JNIEnv*, jobject,
                                                            jlong jhandle) {
  auto* options =
      reinterpret_cast<ROCKSDB_NAMESPACE::IngestExternalFileOptions*>(jhandle);
...
Java_org_forstdb_IngestExternalFileOptions_setWriteGlobalSeqno(
 ...
 * Signature: (J)V
 */
void Java_org_forstdb_IngestExternalFileOptions_disposeInternal(JNIEnv*,
                                                                jobject,
                                                                jlong jhandle) {
  auto* options =
      reinterpret_cast<ROCKSDB_NAMESPACE::IngestExternalFileOptions*>(jhandle);
