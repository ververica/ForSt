...
#include "include/org_forstdb_EnvOptions.h"
 ...
 * Signature: ()J
 */
jlong Java_org_forstdb_EnvOptions_newEnvOptions__(JNIEnv *, jclass) {
 ...
 * Signature: (J)J
 */
jlong Java_org_forstdb_EnvOptions_newEnvOptions__J(JNIEnv *, jclass,
 ...
 * Signature: (J)V
 */
void Java_org_forstdb_EnvOptions_disposeInternal(JNIEnv *, jobject,
                                                 jlong jhandle) {
 ...
 * Signature: (JZ)V
 */
void Java_org_forstdb_EnvOptions_setUseMmapReads(JNIEnv *, jobject,
                                                 jlong jhandle,
 ...
 * Signature: (J)Z
 */
jboolean Java_org_forstdb_EnvOptions_useMmapReads(JNIEnv *, jobject,
                                                  jlong jhandle) {
 ...
 * Signature: (JZ)V
 */
void Java_org_forstdb_EnvOptions_setUseMmapWrites(JNIEnv *, jobject,
                                                  jlong jhandle,
 ...
 * Signature: (J)Z
 */
jboolean Java_org_forstdb_EnvOptions_useMmapWrites(JNIEnv *, jobject,
                                                   jlong jhandle) {
 ...
 * Signature: (JZ)V
 */
void Java_org_forstdb_EnvOptions_setUseDirectReads(JNIEnv *, jobject,
                                                   jlong jhandle,
 ...
 * Signature: (J)Z
 */
jboolean Java_org_forstdb_EnvOptions_useDirectReads(JNIEnv *, jobject,
                                                    jlong jhandle) {
 ...
 * Signature: (J)Z
 */
jboolean Java_org_forstdb_EnvOptions_useDirectWrites(JNIEnv *, jobject,
                                                     jlong jhandle) {
 ...
 * Signature: (JZ)V
 */
void Java_org_forstdb_EnvOptions_setAllowFallocate(JNIEnv *, jobject,
                                                   jlong jhandle,
 ...
 * Signature: (J)Z
 */
jboolean Java_org_forstdb_EnvOptions_allowFallocate(JNIEnv *, jobject,
                                                    jlong jhandle) {
 ...
 * Signature: (JZ)V
 */
void Java_org_forstdb_EnvOptions_setSetFdCloexec(JNIEnv *, jobject,
                                                 jlong jhandle,
 ...
 * Signature: (J)Z
 */
jboolean Java_org_forstdb_EnvOptions_setFdCloexec(JNIEnv *, jobject,
                                                  jlong jhandle) {
 ...
 * Signature: (JJ)V
 */
void Java_org_forstdb_EnvOptions_setBytesPerSync(JNIEnv *, jobject,
                                                 jlong jhandle,
 ...
 * Signature: (J)J
 */
jlong Java_org_forstdb_EnvOptions_bytesPerSync(JNIEnv *, jobject,
                                               jlong jhandle) {
 ...
 * Signature: (JZ)V
 */
void Java_org_forstdb_EnvOptions_setFallocateWithKeepSize(
 ...
 * Signature: (J)Z
 */
jboolean Java_org_forstdb_EnvOptions_fallocateWithKeepSize(JNIEnv *, jobject,
                                                           jlong jhandle) {
 ...
 * Signature: (JJ)V
 */
void Java_org_forstdb_EnvOptions_setCompactionReadaheadSize(
 ...
 * Signature: (J)J
 */
jlong Java_org_forstdb_EnvOptions_compactionReadaheadSize(JNIEnv *, jobject,
                                                          jlong jhandle) {
 ...
 * Signature: (J)J
 */
jlong Java_org_forstdb_EnvOptions_randomAccessMaxBufferSize(JNIEnv *, jobject,
                                                            jlong jhandle) {
 ...
 * Signature: (JJ)V
 */
void Java_org_forstdb_EnvOptions_setWritableFileMaxBufferSize(
 ...
 * Signature: (J)J
 */
jlong Java_org_forstdb_EnvOptions_writableFileMaxBufferSize(JNIEnv *, jobject,
                                                            jlong jhandle) {
 ...
 * Signature: (JJ)V
 */
void Java_org_forstdb_EnvOptions_setRateLimiter(JNIEnv *, jobject,
                                                jlong jhandle,
                                                jlong rl_handle) {
