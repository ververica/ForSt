...
#include "include/org_forstdb_ConfigOptions.h"
 ...
 * Signature: (J)V
 */
void Java_org_forstdb_ConfigOptions_disposeInternal(JNIEnv *, jobject,
                                                    jlong jhandle) {
 ...
 * Signature: ()J
 */
jlong Java_org_forstdb_ConfigOptions_newConfigOptions(JNIEnv *, jclass) {
 ...
 * Signature: (JJ;)V
 */
void Java_org_forstdb_ConfigOptions_setEnv(JNIEnv *, jclass, jlong handle,
 ...
 */
void Java_org_forstdb_ConfigOptions_setDelimiter(JNIEnv *env, jclass,
 ...
 * Signature: (JZ)V
 */
void Java_org_forstdb_ConfigOptions_setIgnoreUnknownOptions(JNIEnv *, jclass,
                                                            jlong handle,
                                                            jboolean b) {
  auto *cfg_opt = reinterpret_cast<ROCKSDB_NAMESPACE::ConfigOptions *>(handle);
 ...
 * Signature: (JZ)V
 */
void Java_org_forstdb_ConfigOptions_setInputStringsEscaped(JNIEnv *, jclass,
                                                           jlong handle,
                                                           jboolean b) {
  auto *cfg_opt = reinterpret_cast<ROCKSDB_NAMESPACE::ConfigOptions *>(handle);
 ...
 * Signature: (JI)V
 */
void Java_org_forstdb_ConfigOptions_setSanityLevel(JNIEnv *, jclass,
