...
#include "include/org_forstdb_PersistentCache.h"
 ...
 */
jlong Java_org_forstdb_PersistentCache_newPersistentCache(
 ...
 * Signature: (J)V
 */
void Java_org_forstdb_PersistentCache_disposeInternal(JNIEnv*, jobject,
                                                      jlong jhandle) {
  auto* cache =
