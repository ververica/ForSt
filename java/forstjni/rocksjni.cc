...
#include "include/org_forstdb_RocksDB.h"
 ...
 */
jlong Java_org_forstdb_RocksDB_open__JLjava_lang_String_2(JNIEnv* env, jclass,
                                                          jlong jopt_handle,
                                                          jstring jdb_path) {
 ...
 */
jlong Java_org_forstdb_RocksDB_openROnly__JLjava_lang_String_2Z(
 ...
 */
jlongArray Java_org_forstdb_RocksDB_openROnly__JLjava_lang_String_2_3_3B_3JZ(
    JNIEnv* env, jclass, jlong jopt_handle, jstring jdb_path,
    jobjectArray jcolumn_names, jlongArray jcolumn_options,
    jboolean jerror_if_wal_file_exists) {
  const bool error_if_wal_file_exists = jerror_if_wal_file_exists == JNI_TRUE;
 ...
 */
jlongArray Java_org_forstdb_RocksDB_open__JLjava_lang_String_2_3_3B_3J(
    JNIEnv* env, jclass, jlong jopt_handle, jstring jdb_path,
    jobjectArray jcolumn_names, jlongArray jcolumn_options) {
  return rocksdb_open_helper(
      env, jopt_handle, jdb_path, jcolumn_names, jcolumn_options,
 ...
 */
jlongArray
Java_org_forstdb_RocksDB_openAsSecondary__JLjava_lang_String_2Ljava_lang_String_2_3_3B_3J(
    JNIEnv* env, jclass, jlong jopt_handle, jstring jdb_path,
 ...
 * Signature: (J)V
 */
void Java_org_forstdb_RocksDB_disposeInternal(JNIEnv*, jobject, jlong jhandle) {
 ...
 * Signature: (J)V
 */
void Java_org_forstdb_RocksDB_closeDatabase(JNIEnv* env, jclass,
                                            jlong jhandle) {
  auto* db = reinterpret_cast<ROCKSDB_NAMESPACE::DB*>(jhandle);
  assert(db != nullptr);
 ...
 */
jobjectArray Java_org_forstdb_RocksDB_listColumnFamilies(JNIEnv* env, jclass,
                                                         jlong jopt_handle,
                                                         jstring jdb_path) {
 ...
 * Signature: (J[BIJ)J
 */
jlong Java_org_forstdb_RocksDB_createColumnFamily(JNIEnv* env, jobject,
                                                  jlong jhandle,
                                                  jbyteArray jcf_name,
                                                  jint jcf_name_len,
 ...
 */
jlong Java_org_forstdb_RocksDB_createColumnFamilyWithImport(
 ...
 * Signature: (JJ)V;
 */
void Java_org_forstdb_RocksDB_dropColumnFamily(JNIEnv* env, jobject,
                                               jlong jdb_handle,
                                               jlong jcf_handle) {
 ...
 */
void Java_org_forstdb_RocksDB_put__J_3BII_3BII(JNIEnv* env, jobject,
                                               jlong jdb_handle,
 ...
 */
void Java_org_forstdb_RocksDB_put__J_3BII_3BIIJ(JNIEnv* env, jobject,
                                                jlong jdb_handle,
                                                jbyteArray jkey, jint jkey_off,
                                                jint jkey_len, jbyteArray jval,
                                                jint jval_off, jint jval_len,
 ...
 */
void Java_org_forstdb_RocksDB_put__JJ_3BII_3BII(JNIEnv* env, jobject,
                                                jlong jdb_handle,
 ...
 */
void Java_org_forstdb_RocksDB_put__JJ_3BII_3BIIJ(
 ...
 */
void Java_org_forstdb_RocksDB_putDirect(
 ...
 * Signature: (J[BII)V
 */
void Java_org_forstdb_RocksDB_delete__J_3BII(JNIEnv* env, jobject,
 ...
 * Signature: (J[BIIJ)V
 */
void Java_org_forstdb_RocksDB_delete__J_3BIIJ(JNIEnv* env, jobject,
                                              jlong jdb_handle, jbyteArray jkey,
                                              jint jkey_off, jint jkey_len,
                                              jlong jcf_handle) {
  auto* db = reinterpret_cast<ROCKSDB_NAMESPACE::DB*>(jdb_handle);
 ...
 * Signature: (JJ[BII)V
 */
void Java_org_forstdb_RocksDB_delete__JJ_3BII(JNIEnv* env, jobject,
                                              jlong jdb_handle,
 ...
 * Signature: (JJ[BIIJ)V
 */
void Java_org_forstdb_RocksDB_delete__JJ_3BIIJ(
 ...
 * Signature: (J[BI)V
 */
void Java_org_forstdb_RocksDB_singleDelete__J_3BI(JNIEnv* env, jobject,
                                                  jlong jdb_handle,
                                                  jbyteArray jkey,
                                                  jint jkey_len) {
  auto* db = reinterpret_cast<ROCKSDB_NAMESPACE::DB*>(jdb_handle);
 ...
 * Signature: (J[BIJ)V
 */
void Java_org_forstdb_RocksDB_singleDelete__J_3BIJ(JNIEnv* env, jobject,
                                                   jlong jdb_handle,
                                                   jbyteArray jkey,
                                                   jint jkey_len,
                                                   jlong jcf_handle) {
 ...
 * Signature: (JJ[BIJ)V
 */
void Java_org_forstdb_RocksDB_singleDelete__JJ_3BI(JNIEnv* env, jobject,
                                                   jlong jdb_handle,
                                                   jlong jwrite_options,
                                                   jbyteArray jkey,
                                                   jint jkey_len) {
 ...
 * Signature: (JJ[BIJ)V
 */
void Java_org_forstdb_RocksDB_singleDelete__JJ_3BIJ(
    JNIEnv* env, jobject, jlong jdb_handle, jlong jwrite_options,
 ...
 * Signature: (J[BII[BII)V
 */
void Java_org_forstdb_RocksDB_deleteRange__J_3BII_3BII(
 ...
 * Signature: (J[BII[BIIJ)V
 */
void Java_org_forstdb_RocksDB_deleteRange__J_3BII_3BIIJ(
    JNIEnv* env, jobject, jlong jdb_handle, jbyteArray jbegin_key,
    jint jbegin_key_off, jint jbegin_key_len, jbyteArray jend_key,
 ...
 * Signature: (JJ[BII[BII)V
 */
void Java_org_forstdb_RocksDB_deleteRange__JJ_3BII_3BII(
    JNIEnv* env, jobject, jlong jdb_handle, jlong jwrite_options,
 ...
 * Signature: (JJ[BII[BIIJ)V
 */
void Java_org_forstdb_RocksDB_deleteRange__JJ_3BII_3BIIJ(
    JNIEnv* env, jobject, jlong jdb_handle, jlong jwrite_options,
    jbyteArray jbegin_key, jint jbegin_key_off, jint jbegin_key_len,
    jbyteArray jend_key, jint jend_key_off, jint jend_key_len,
    jlong jcf_handle) {
 ...
 * Signature: (JJ[BII[BII)V
 */
void Java_org_forstdb_RocksDB_clipColumnFamily(
 ...
 */
jint Java_org_forstdb_RocksDB_getDirect(JNIEnv* env, jobject /*jdb*/,
 ...
 * Signature: (J[BII[BII)V
 */
void Java_org_forstdb_RocksDB_merge__J_3BII_3BII(JNIEnv* env, jobject,
                                                 jlong jdb_handle,
                                                 jbyteArray jkey, jint jkey_off,
                                                 jint jkey_len, jbyteArray jval,
                                                 jint jval_off, jint jval_len) {
 ...
 * Signature: (J[BII[BIIJ)V
 */
void Java_org_forstdb_RocksDB_merge__J_3BII_3BIIJ(
 ...
 * Signature: (JJ[BII[BIIJ)V
 */
void Java_org_forstdb_RocksDB_merge__JJ_3BII_3BIIJ(
    JNIEnv* env, jobject, jlong jdb_handle, jlong jwrite_options_handle,
    jbyteArray jkey, jint jkey_off, jint jkey_len, jbyteArray jval,
    jint jval_off, jint jval_len, jlong jcf_handle) {
  auto* db = reinterpret_cast<ROCKSDB_NAMESPACE::DB*>(jdb_handle);
 ...
 */
void Java_org_forstdb_RocksDB_deleteDirect(JNIEnv* env, jobject /*jdb*/,
                                           jlong jdb_handle,
 ...
 * Signature: (JJJ)V
 */
void Java_org_forstdb_RocksDB_write0(JNIEnv* env, jobject, jlong jdb_handle,
                                     jlong jwrite_options_handle,
                                     jlong jwb_handle) {
  auto* db = reinterpret_cast<ROCKSDB_NAMESPACE::DB*>(jdb_handle);
  auto* write_options =
 ...
 * Signature: (JJJ)V
 */
void Java_org_forstdb_RocksDB_write1(JNIEnv* env, jobject, jlong jdb_handle,
                                     jlong jwrite_options_handle,
                                     jlong jwbwi_handle) {
  auto* db = reinterpret_cast<ROCKSDB_NAMESPACE::DB*>(jdb_handle);
  auto* write_options =
 ...
 * Signature: (J[BII)[B
 */
jbyteArray Java_org_forstdb_RocksDB_get__J_3BII(JNIEnv* env, jobject,
                                                jlong jdb_handle,
                                                jbyteArray jkey, jint jkey_off,
                                                jint jkey_len) {
 ...
 * Signature: (J[BIIJ)[B
 */
jbyteArray Java_org_forstdb_RocksDB_get__J_3BIIJ(JNIEnv* env, jobject,
                                                 jlong jdb_handle,
                                                 jbyteArray jkey, jint jkey_off,
                                                 jint jkey_len,
                                                 jlong jcf_handle) {
 ...
 * Signature: (JJ[BII)[B
 */
jbyteArray Java_org_forstdb_RocksDB_get__JJ_3BII(JNIEnv* env, jobject,
                                                 jlong jdb_handle,
                                                 jlong jropt_handle,
                                                 jbyteArray jkey, jint jkey_off,
                                                 jint jkey_len) {
 ...
 * Signature: (JJ[BIIJ)[B
 */
jbyteArray Java_org_forstdb_RocksDB_get__JJ_3BIIJ(
 ...
 */
jint Java_org_forstdb_RocksDB_get__J_3BII_3BII(JNIEnv* env, jobject,
                                               jlong jdb_handle,
                                               jbyteArray jkey, jint jkey_off,
                                               jint jkey_len, jbyteArray jval,
                                               jint jval_off, jint jval_len) {
 ...
 */
jint Java_org_forstdb_RocksDB_get__J_3BII_3BIIJ(JNIEnv* env, jobject,
                                                jlong jdb_handle,
                                                jbyteArray jkey, jint jkey_off,
                                                jint jkey_len, jbyteArray jval,
                                                jint jval_off, jint jval_len,
 ...
 */
jint Java_org_forstdb_RocksDB_get__JJ_3BII_3BII(JNIEnv* env, jobject,
                                                jlong jdb_handle,
                                                jlong jropt_handle,
                                                jbyteArray jkey, jint jkey_off,
                                                jint jkey_len, jbyteArray jval,
 ...
 */
jint Java_org_forstdb_RocksDB_get__JJ_3BII_3BIIJ(
    JNIEnv* env, jobject, jlong jdb_handle, jlong jropt_handle, jbyteArray jkey,
 ...
 * Signature: (J[[B[I[I)[[B
 */
jobjectArray Java_org_forstdb_RocksDB_multiGet__J_3_3B_3I_3I(
 ...
 */
jobjectArray Java_org_forstdb_RocksDB_multiGet__JJ_3_3B_3I_3I(
 ...
 * Signature: (JJJ[BII)Z
 */
jboolean Java_org_forstdb_RocksDB_keyExists(JNIEnv* env, jobject,
 ...
 */
jboolean Java_org_forstdb_RocksDB_keyExistsDirect(
    JNIEnv* env, jobject, jlong jdb_handle, jlong jcf_handle,
 ...
 * Signature: (JJJ[BII)Z
 */
jboolean Java_org_forstdb_RocksDB_keyMayExist(
    JNIEnv* env, jobject, jlong jdb_handle, jlong jcf_handle,
 ...
 * Signature: (JJJLjava/nio/ByteBuffer;II)Z
 */
jboolean Java_org_forstdb_RocksDB_keyMayExistDirect(
    JNIEnv* env, jobject, jlong jdb_handle, jlong jcf_handle,
    jlong jread_opts_handle, jobject jkey, jint jkey_offset, jint jkey_len) {
  bool has_exception = false;
  std::string value;
 ...
 * Signature: (JJJ[BII)[[B
 */
jobjectArray Java_org_forstdb_RocksDB_keyMayExistFoundValue(
    JNIEnv* env, jobject, jlong jdb_handle, jlong jcf_handle,
    jlong jread_opts_handle, jbyteArray jkey, jint jkey_offset, jint jkey_len) {
  bool has_exception = false;
  std::string value;
 ...
 * Signature: (JJJ)J
 */
jlong Java_org_forstdb_RocksDB_iterator(JNIEnv*, jobject, jlong db_handle,
                                        jlong jcf_handle,
 ...
 * Signature: (J[JJ)[J
 */
jlongArray Java_org_forstdb_RocksDB_iterators(JNIEnv* env, jobject,
                                              jlong db_handle,
                                              jlongArray jcolumn_family_handles,
                                              jlong jread_options_handle) {
  auto* db = reinterpret_cast<ROCKSDB_NAMESPACE::DB*>(db_handle);
 ...
 * Signature: (J)J
 */
jlong Java_org_forstdb_RocksDB_getSnapshot(JNIEnv*, jobject, jlong db_handle) {
  auto* db = reinterpret_cast<ROCKSDB_NAMESPACE::DB*>(db_handle);
 ...
 * Signature: (JJ)V
 */
void Java_org_forstdb_RocksDB_releaseSnapshot(JNIEnv*, jobject, jlong db_handle,
 ...
 */
jstring Java_org_forstdb_RocksDB_getProperty(JNIEnv* env, jobject,
                                             jlong jdb_handle, jlong jcf_handle,
                                             jstring jproperty,
                                             jint jproperty_len) {
 ...
 */
jobject Java_org_forstdb_RocksDB_getMapProperty(JNIEnv* env, jobject,
                                                jlong jdb_handle,
                                                jlong jcf_handle,
                                                jstring jproperty,
                                                jint jproperty_len) {
 ...
 */
jlong Java_org_forstdb_RocksDB_getLongProperty(JNIEnv* env, jobject,
                                               jlong jdb_handle,
                                               jlong jcf_handle,
                                               jstring jproperty,
                                               jint jproperty_len) {
 ...
 * Signature: (J)V
 */
void Java_org_forstdb_RocksDB_resetStats(JNIEnv*, jobject, jlong jdb_handle) {
  auto* db = reinterpret_cast<ROCKSDB_NAMESPACE::DB*>(jdb_handle);
  db->ResetStats();
}
 ...
 */
jlong Java_org_forstdb_RocksDB_getAggregatedLongProperty(JNIEnv* env, jobject,
                                                         jlong db_handle,
                                                         jstring jproperty,
                                                         jint jproperty_len) {
  const char* property = env->GetStringUTFChars(jproperty, nullptr);
 ...
 * Signature: (JJ[JB)[J
 */
jlongArray Java_org_forstdb_RocksDB_getApproximateSizes(
    JNIEnv* env, jobject, jlong jdb_handle, jlong jcf_handle,
 ...
 * Signature: (JJJJ)[J
 */
jlongArray Java_org_forstdb_RocksDB_getApproximateMemTableStats(
    JNIEnv* env, jobject, jlong jdb_handle, jlong jcf_handle,
 ...
 */
void Java_org_forstdb_RocksDB_compactRange(JNIEnv* env, jobject,
 ...
 */
void Java_org_forstdb_RocksDB_setOptions(JNIEnv* env, jobject, jlong jdb_handle,
 ...
 */
void Java_org_forstdb_RocksDB_setDBOptions(JNIEnv* env, jobject,
 ...
 */
jstring Java_org_forstdb_RocksDB_getOptions(JNIEnv* env, jobject,
                                            jlong jdb_handle,
                                            jlong jcf_handle) {
  auto* db = reinterpret_cast<ROCKSDB_NAMESPACE::DB*>(jdb_handle);
 ...
 */
jstring Java_org_forstdb_RocksDB_getDBOptions(JNIEnv* env, jobject,
                                              jlong jdb_handle) {
  auto* db = reinterpret_cast<ROCKSDB_NAMESPACE::DB*>(jdb_handle);
 ...
 * Signature: (JB)V
 */
void Java_org_forstdb_RocksDB_setPerfLevel(JNIEnv*, jobject,
                                           jbyte jperf_level) {
 ...
 * Signature: (J)B
 */
jbyte Java_org_forstdb_RocksDB_getPerfLevelNative(JNIEnv*, jobject) {
 ...
 * Signature: ()J
 */
jlong Java_org_forstdb_RocksDB_getPerfContextNative(JNIEnv*, jobject) {
  ROCKSDB_NAMESPACE::PerfContext* perf_context = ROCKSDB_NAMESPACE::get_perf_context();
 ...
 */
jobjectArray Java_org_forstdb_RocksDB_compactFiles(
 ...
 * Signature: (JZ)V
 */
void Java_org_forstdb_RocksDB_cancelAllBackgroundWork(JNIEnv*, jobject,
                                                      jlong jdb_handle,
                                                      jboolean jwait) {
  auto* db = reinterpret_cast<ROCKSDB_NAMESPACE::DB*>(jdb_handle);
 ...
 * Signature: (J)V
 */
void Java_org_forstdb_RocksDB_pauseBackgroundWork(JNIEnv* env, jobject,
                                                  jlong jdb_handle) {
  auto* db = reinterpret_cast<ROCKSDB_NAMESPACE::DB*>(jdb_handle);
 ...
 * Signature: (J)V
 */
void Java_org_forstdb_RocksDB_continueBackgroundWork(JNIEnv* env, jobject,
                                                     jlong jdb_handle) {
  auto* db = reinterpret_cast<ROCKSDB_NAMESPACE::DB*>(jdb_handle);
 ...
 * Signature: (J[J)V
 */
void Java_org_forstdb_RocksDB_enableAutoCompaction(JNIEnv* env, jobject,
                                                   jlong jdb_handle,
 ...
 * Signature: (JJ)I
 */
jint Java_org_forstdb_RocksDB_numberLevels(JNIEnv*, jobject, jlong jdb_handle,
                                           jlong jcf_handle) {
  auto* db = reinterpret_cast<ROCKSDB_NAMESPACE::DB*>(jdb_handle);
  ROCKSDB_NAMESPACE::ColumnFamilyHandle* cf_handle;
  if (jcf_handle == 0) {
 ...
 * Signature: (JJ)I
 */
jint Java_org_forstdb_RocksDB_maxMemCompactionLevel(JNIEnv*, jobject,
                                                    jlong jdb_handle,
                                                    jlong jcf_handle) {
  auto* db = reinterpret_cast<ROCKSDB_NAMESPACE::DB*>(jdb_handle);
  ROCKSDB_NAMESPACE::ColumnFamilyHandle* cf_handle;
 ...
 * Signature: (JJ)I
 */
jint Java_org_forstdb_RocksDB_level0StopWriteTrigger(JNIEnv*, jobject,
                                                     jlong jdb_handle,
                                                     jlong jcf_handle) {
  auto* db = reinterpret_cast<ROCKSDB_NAMESPACE::DB*>(jdb_handle);
  ROCKSDB_NAMESPACE::ColumnFamilyHandle* cf_handle;
 ...
 * Signature: (J)Ljava/lang/String;
 */
jstring Java_org_forstdb_RocksDB_getName(JNIEnv* env, jobject,
                                         jlong jdb_handle) {
  auto* db = reinterpret_cast<ROCKSDB_NAMESPACE::DB*>(jdb_handle);
 ...
 * Signature: (J)J
 */
jlong Java_org_forstdb_RocksDB_getEnv(JNIEnv*, jobject, jlong jdb_handle) {
  auto* db = reinterpret_cast<ROCKSDB_NAMESPACE::DB*>(jdb_handle);
 ...
 * Signature: (JJ[J)V
 */
void Java_org_forstdb_RocksDB_flush(JNIEnv* env, jobject, jlong jdb_handle,
 ...
 * Signature: (JZ)V
 */
void Java_org_forstdb_RocksDB_flushWal(JNIEnv* env, jobject, jlong jdb_handle,
                                       jboolean jsync) {
  auto* db = reinterpret_cast<ROCKSDB_NAMESPACE::DB*>(jdb_handle);
 ...
 * Signature: (J)V
 */
void Java_org_forstdb_RocksDB_syncWal(JNIEnv* env, jobject, jlong jdb_handle) {
  auto* db = reinterpret_cast<ROCKSDB_NAMESPACE::DB*>(jdb_handle);
  auto s = db->SyncWAL();
  if (!s.ok()) {
    ROCKSDB_NAMESPACE::RocksDBExceptionJni::ThrowNew(env, s);
 ...
 * Signature: (J)V
 */
jlong Java_org_forstdb_RocksDB_getLatestSequenceNumber(JNIEnv*, jobject,
                                                       jlong jdb_handle) {
  auto* db = reinterpret_cast<ROCKSDB_NAMESPACE::DB*>(jdb_handle);
 ...
 * Signature: (J)V
 */
void Java_org_forstdb_RocksDB_disableFileDeletions(JNIEnv* env, jobject,
                                                   jlong jdb_handle) {
  auto* db = reinterpret_cast<ROCKSDB_NAMESPACE::DB*>(jdb_handle);
 ...
 * Signature: (JZ)V
 */
void Java_org_forstdb_RocksDB_enableFileDeletions(JNIEnv* env, jobject,
                                                  jlong jdb_handle,
                                                  jboolean jforce) {
  auto* db = reinterpret_cast<ROCKSDB_NAMESPACE::DB*>(jdb_handle);
 ...
 */
jobjectArray Java_org_forstdb_RocksDB_getLiveFiles(JNIEnv* env, jobject,
                                                   jlong jdb_handle,
 ...
 * Signature: (JJ)J
 */
jlong Java_org_forstdb_RocksDB_getUpdatesSince(JNIEnv* env, jobject,
                                               jlong jdb_handle,
 ...
 */
void Java_org_forstdb_RocksDB_deleteFile(JNIEnv* env, jobject, jlong jdb_handle,
                                         jstring jname) {
  auto* db = reinterpret_cast<ROCKSDB_NAMESPACE::DB*>(jdb_handle);
  jboolean has_exception = JNI_FALSE;
  std::string name =
 ...
 */
void Java_org_forstdb_RocksDB_ingestExternalFile(
    JNIEnv* env, jobject, jlong jdb_handle, jlong jcf_handle,
 ...
 * Signature: (J)V
 */
void Java_org_forstdb_RocksDB_verifyChecksum(JNIEnv* env, jobject,
                                             jlong jdb_handle) {
  auto* db = reinterpret_cast<ROCKSDB_NAMESPACE::DB*>(jdb_handle);
 ...
 * Signature: (J)J
 */
jlong Java_org_forstdb_RocksDB_getDefaultColumnFamily(JNIEnv*, jobject,
                                                      jlong jdb_handle) {
  auto* db_handle = reinterpret_cast<ROCKSDB_NAMESPACE::DB*>(jdb_handle);
 ...
 */
jobject Java_org_forstdb_RocksDB_getPropertiesOfAllTables(JNIEnv* env, jobject,
                                                          jlong jdb_handle,
                                                          jlong jcf_handle) {
  auto* db = reinterpret_cast<ROCKSDB_NAMESPACE::DB*>(jdb_handle);
  ROCKSDB_NAMESPACE::ColumnFamilyHandle* cf_handle;
 ...
 */
jobject Java_org_forstdb_RocksDB_getPropertiesOfTablesInRange(
    JNIEnv* env, jobject, jlong jdb_handle, jlong jcf_handle,
 ...
 * Signature: (JJ)[J
 */
jlongArray Java_org_forstdb_RocksDB_suggestCompactRange(JNIEnv* env, jobject,
                                                        jlong jdb_handle,
                                                        jlong jcf_handle) {
  auto* db = reinterpret_cast<ROCKSDB_NAMESPACE::DB*>(jdb_handle);
  ROCKSDB_NAMESPACE::ColumnFamilyHandle* cf_handle;
 ...
 * Signature: (JJI)V
 */
void Java_org_forstdb_RocksDB_promoteL0(JNIEnv*, jobject, jlong jdb_handle,
 ...
 * Signature: (J)V
 */
void Java_org_forstdb_RocksDB_endTrace(JNIEnv* env, jobject, jlong jdb_handle) {
  auto* db = reinterpret_cast<ROCKSDB_NAMESPACE::DB*>(jdb_handle);
  auto s = db->EndTrace();
  if (!s.ok()) {
    ROCKSDB_NAMESPACE::RocksDBExceptionJni::ThrowNew(env, s);
 ...
 * Signature: (J)V
 */
void Java_org_forstdb_RocksDB_tryCatchUpWithPrimary(JNIEnv* env, jobject,
                                                    jlong jdb_handle) {
  auto* db = reinterpret_cast<ROCKSDB_NAMESPACE::DB*>(jdb_handle);
 ...
 */
void Java_org_forstdb_RocksDB_destroyDB(JNIEnv* env, jclass, jstring jdb_path,
 ...
 */
void Java_org_forstdb_RocksDB_deleteFilesInRanges(JNIEnv* env, jobject /*jdb*/,
                                                  jlong jdb_handle,
                                                  jlong jcf_handle,
                                                  jobjectArray ranges,
 ...
 * Signature: ()I
 */
jint Java_org_forstdb_RocksDB_version(JNIEnv*, jclass) {
