...
#include "include/org_forstdb_RocksCallbackObject.h"
#include "jnicallback.h"

/*
 * Class:     org_forstdb_RocksCallbackObject
 * Method:    disposeInternal
 * Signature: (J)V
 */
void Java_org_forstdb_RocksCallbackObject_disposeInternal(JNIEnv* /*env*/,
                                                          jobject /*jobj*/,
                                                          jlong handle) {
