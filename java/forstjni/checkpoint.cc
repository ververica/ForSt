...
#include "include/org_forstdb_Checkpoint.h"
 ...
 * Signature: (J)J
 */
jlong Java_org_forstdb_Checkpoint_newCheckpoint(JNIEnv* /*env*/,
                                                jclass /*jclazz*/,
                                                jlong jdb_handle) {
 ...
 * Signature: (J)V
 */
void Java_org_forstdb_Checkpoint_disposeInternal(JNIEnv* /*env*/,
                                                 jobject /*jobj*/,
                                                 jlong jhandle) {
 ...
 */
void Java_org_forstdb_Checkpoint_createCheckpoint(JNIEnv* env, jobject /*jobj*/,
