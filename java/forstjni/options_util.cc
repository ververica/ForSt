...
#include "include/org_forstdb_OptionsUtil.h"
 ...
 */
void Java_org_forstdb_OptionsUtil_loadLatestOptions(
 ...
 * Signature: (JLjava/lang/String;JLjava/util/List;)V
 */
void Java_org_forstdb_OptionsUtil_loadOptionsFromFile(
 ...
 */
jstring Java_org_forstdb_OptionsUtil_getLatestOptionsFileName(
