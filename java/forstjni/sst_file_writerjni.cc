...
#include "include/org_forstdb_SstFileWriter.h"
 ...
 * Signature: (JJJB)J
 */
jlong Java_org_forstdb_SstFileWriter_newSstFileWriter__JJJB(
 ...
 * Signature: (JJ)J
 */
jlong Java_org_forstdb_SstFileWriter_newSstFileWriter__JJ(JNIEnv * /*env*/,
                                                          jclass /*jcls*/,
                                                          jlong jenvoptions,
                                                          jlong joptions) {
  auto *env_options =
 ...
 */
void Java_org_forstdb_SstFileWriter_open(JNIEnv *env, jobject /*jobj*/,
 ...
 * Signature: (JJJ)V
 */
void Java_org_forstdb_SstFileWriter_put__JJJ(JNIEnv *env, jobject /*jobj*/,
 ...
 * Signature: (JJJ)V
 */
void Java_org_forstdb_SstFileWriter_put__J_3B_3B(JNIEnv *env, jobject /*jobj*/,
 ...
 */
void Java_org_forstdb_SstFileWriter_putDirect(JNIEnv *env, jobject /*jdb*/,
 ...
 * Signature: (J)J
 */
jlong Java_org_forstdb_SstFileWriter_fileSize(JNIEnv * /*env*/, jobject /*jdb*/,
                                              jlong jdb_handle) {
  auto *writer =
      reinterpret_cast<ROCKSDB_NAMESPACE::SstFileWriter *>(jdb_handle);
 ...
 * Signature: (JJJ)V
 */
void Java_org_forstdb_SstFileWriter_merge__JJJ(JNIEnv *env, jobject /*jobj*/,
                                               jlong jhandle, jlong jkey_handle,
                                               jlong jvalue_handle) {
  auto *key_slice = reinterpret_cast<ROCKSDB_NAMESPACE::Slice *>(jkey_handle);
  auto *value_slice =
 ...
 * Signature: (J[B[B)V
 */
void Java_org_forstdb_SstFileWriter_merge__J_3B_3B(JNIEnv *env,
                                                   jobject /*jobj*/,
                                                   jlong jhandle,
                                                   jbyteArray jkey,
                                                   jbyteArray jval) {
 ...
 * Signature: (JJJ)V
 */
void Java_org_forstdb_SstFileWriter_delete__J_3B(JNIEnv *env, jobject /*jobj*/,
                                                 jlong jhandle,
                                                 jbyteArray jkey) {
  jbyte *key = env->GetByteArrayElements(jkey, nullptr);
  if (key == nullptr) {
 ...
 * Signature: (JJJ)V
 */
void Java_org_forstdb_SstFileWriter_delete__JJ(JNIEnv *env, jobject /*jobj*/,
                                               jlong jhandle,
                                               jlong jkey_handle) {
  auto *key_slice = reinterpret_cast<ROCKSDB_NAMESPACE::Slice *>(jkey_handle);
  ROCKSDB_NAMESPACE::Status s =
 ...
 * Signature: (J)V
 */
void Java_org_forstdb_SstFileWriter_finish(JNIEnv *env, jobject /*jobj*/,
                                           jlong jhandle) {
  ROCKSDB_NAMESPACE::Status s =
 ...
 * Signature: (J)V
 */
void Java_org_forstdb_SstFileWriter_disposeInternal(JNIEnv * /*env*/,
                                                    jobject /*jobj*/,
                                                    jlong jhandle) {
