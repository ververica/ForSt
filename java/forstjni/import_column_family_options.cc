...
#include "include/org_forstdb_ImportColumnFamilyOptions.h"
 ...
 * Signature: ()J
 */
jlong Java_org_forstdb_ImportColumnFamilyOptions_newImportColumnFamilyOptions(
    JNIEnv *, jclass) {
 ...
 * Signature: (J)Z
 */
jboolean Java_org_forstdb_ImportColumnFamilyOptions_moveFiles(JNIEnv *, jobject,
                                                              jlong jhandle) {
  auto *options =
      reinterpret_cast<ROCKSDB_NAMESPACE::ImportColumnFamilyOptions *>(jhandle);
 ...
 * Signature: (J)V
 */
void Java_org_forstdb_ImportColumnFamilyOptions_disposeInternal(JNIEnv *,
                                                                jobject,
                                                                jlong jhandle) {
