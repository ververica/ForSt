...
#include "include/org_forstdb_SstFileReader.h"
 ...
 * Signature: (J)J
 */
jlong Java_org_forstdb_SstFileReader_newSstFileReader(JNIEnv * /*env*/,
                                                      jclass /*jcls*/,
                                                      jlong joptions) {
  auto *options =
 ...
 */
void Java_org_forstdb_SstFileReader_open(JNIEnv *env, jobject /*jobj*/,
 ...
 * Signature: (JJ)J
 */
jlong Java_org_forstdb_SstFileReader_newIterator(JNIEnv * /*env*/,
                                                 jobject /*jobj*/,
                                                 jlong jhandle,
 ...
 * Signature: (J)V
 */
void Java_org_forstdb_SstFileReader_disposeInternal(JNIEnv * /*env*/,
                                                    jobject /*jobj*/,
                                                    jlong jhandle) {
 ...
 * Signature: (J)V
 */
void Java_org_forstdb_SstFileReader_verifyChecksum(JNIEnv *env,
                                                   jobject /*jobj*/,
                                                   jlong jhandle) {
  auto *sst_file_reader =
      reinterpret_cast<ROCKSDB_NAMESPACE::SstFileReader *>(jhandle);
 ...
 * Signature: (J)J
 */
jobject Java_org_forstdb_SstFileReader_getTableProperties(JNIEnv *env,
                                                          jobject /*jobj*/,
                                                          jlong jhandle) {
  auto *sst_file_reader =
      reinterpret_cast<ROCKSDB_NAMESPACE::SstFileReader *>(jhandle);
