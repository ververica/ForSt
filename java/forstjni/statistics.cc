...
#include "include/org_forstdb_Statistics.h"
 ...
 * Signature: ()J
 */
jlong Java_org_forstdb_Statistics_newStatistics__(JNIEnv* env, jclass jcls) {
  return Java_org_forstdb_Statistics_newStatistics___3BJ(env, jcls, nullptr, 0);
}
 ...
 * Signature: (J)J
 */
jlong Java_org_forstdb_Statistics_newStatistics__J(
    JNIEnv* env, jclass jcls, jlong jother_statistics_handle) {
  return Java_org_forstdb_Statistics_newStatistics___3BJ(
 ...
 * Signature: ([B)J
 */
jlong Java_org_forstdb_Statistics_newStatistics___3B(JNIEnv* env, jclass jcls,
                                                     jbyteArray jhistograms) {
  return Java_org_forstdb_Statistics_newStatistics___3BJ(env, jcls, jhistograms,
                                                         0);
}
 ...
 * Signature: ([BJ)J
 */
jlong Java_org_forstdb_Statistics_newStatistics___3BJ(
 ...
 * Signature: (J)V
 */
void Java_org_forstdb_Statistics_disposeInternal(JNIEnv*, jobject,
                                                 jlong jhandle) {
  if (jhandle > 0) {
    auto* pSptr_statistics =
        reinterpret_cast<std::shared_ptr<ROCKSDB_NAMESPACE::Statistics>*>(
 ...
 * Signature: (J)B
 */
jbyte Java_org_forstdb_Statistics_statsLevel(JNIEnv*, jobject, jlong jhandle) {
  auto* pSptr_statistics =
      reinterpret_cast<std::shared_ptr<ROCKSDB_NAMESPACE::Statistics>*>(
          jhandle);
 ...
 * Signature: (JB)V
 */
void Java_org_forstdb_Statistics_setStatsLevel(JNIEnv*, jobject, jlong jhandle,
                                               jbyte jstats_level) {
  auto* pSptr_statistics =
      reinterpret_cast<std::shared_ptr<ROCKSDB_NAMESPACE::Statistics>*>(
          jhandle);
 ...
 * Signature: (JB)J
 */
jlong Java_org_forstdb_Statistics_getTickerCount(JNIEnv*, jobject,
                                                 jlong jhandle,
                                                 jbyte jticker_type) {
  auto* pSptr_statistics =
      reinterpret_cast<std::shared_ptr<ROCKSDB_NAMESPACE::Statistics>*>(
 ...
 * Signature: (JB)J
 */
jlong Java_org_forstdb_Statistics_getAndResetTickerCount(JNIEnv*, jobject,
                                                         jlong jhandle,
                                                         jbyte jticker_type) {
  auto* pSptr_statistics =
      reinterpret_cast<std::shared_ptr<ROCKSDB_NAMESPACE::Statistics>*>(
 ...
 */
jstring Java_org_forstdb_Statistics_getHistogramString(JNIEnv* env, jobject,
                                                       jlong jhandle,
                                                       jbyte jhistogram_type) {
  auto* pSptr_statistics =
      reinterpret_cast<std::shared_ptr<ROCKSDB_NAMESPACE::Statistics>*>(
 ...
 * Signature: (J)V
 */
void Java_org_forstdb_Statistics_reset(JNIEnv* env, jobject, jlong jhandle) {
  auto* pSptr_statistics =
      reinterpret_cast<std::shared_ptr<ROCKSDB_NAMESPACE::Statistics>*>(
          jhandle);
  assert(pSptr_statistics != nullptr);
 ...
 */
jstring Java_org_forstdb_Statistics_toString(JNIEnv* env, jobject,
                                             jlong jhandle) {
  auto* pSptr_statistics =
      reinterpret_cast<std::shared_ptr<ROCKSDB_NAMESPACE::Statistics>*>(
          jhandle);
