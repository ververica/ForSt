...
#include "include/org_forstdb_StringAppendOperator.h"
#include "include/org_forstdb_UInt64AddOperator.h"
 ...
 * Signature: (C)J
 */
jlong Java_org_forstdb_StringAppendOperator_newSharedStringAppendOperator__C(
...
jlong Java_org_forstdb_StringAppendOperator_newSharedStringAppendOperator__Ljava_lang_String_2(
 ...
 * Signature: (J)V
 */
void Java_org_forstdb_StringAppendOperator_disposeInternal(JNIEnv* /*env*/,
                                                           jobject /*jobj*/,
                                                           jlong jhandle) {
  auto* sptr_string_append_op =
 ...
 * Signature: ()J
 */
jlong Java_org_forstdb_UInt64AddOperator_newSharedUInt64AddOperator(
 ...
 * Signature: (J)V
 */
void Java_org_forstdb_UInt64AddOperator_disposeInternal(JNIEnv* /*env*/,
                                                        jobject /*jobj*/,
                                                        jlong jhandle) {
  auto* sptr_uint64_add_op =
      reinterpret_cast<std::shared_ptr<ROCKSDB_NAMESPACE::MergeOperator>*>(
