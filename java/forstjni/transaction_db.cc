...
#include "include/org_forstdb_TransactionDB.h"
 ...
 */
jlong Java_org_forstdb_TransactionDB_open__JJLjava_lang_String_2(
 ...
 */
jlongArray Java_org_forstdb_TransactionDB_open__JJLjava_lang_String_2_3_3B_3J(
 ...
 * Signature: (J)V
 */
void Java_org_forstdb_TransactionDB_disposeInternal(JNIEnv*, jobject,
                                                    jlong jhandle) {
 ...
 * Signature: (J)V
 */
void Java_org_forstdb_TransactionDB_closeDatabase(JNIEnv* env, jclass,
                                                  jlong jhandle) {
  auto* txn_db = reinterpret_cast<ROCKSDB_NAMESPACE::TransactionDB*>(jhandle);
  assert(txn_db != nullptr);
 ...
 * Signature: (JJ)J
 */
jlong Java_org_forstdb_TransactionDB_beginTransaction__JJ(
 ...
 * Signature: (JJJJ)J
 */
jlong Java_org_forstdb_TransactionDB_beginTransaction_1withOld__JJJJ(
    JNIEnv*, jobject, jlong jhandle, jlong jwrite_options_handle,
 ...
 */
jlong Java_org_forstdb_TransactionDB_getTransactionByName(JNIEnv* env, jobject,
                                                          jlong jhandle,
                                                          jstring jname) {
  auto* txn_db = reinterpret_cast<ROCKSDB_NAMESPACE::TransactionDB*>(jhandle);
 ...
 * Signature: (J)[J
 */
jlongArray Java_org_forstdb_TransactionDB_getAllPreparedTransactions(
 ...
 */
jobject Java_org_forstdb_TransactionDB_getLockStatusData(JNIEnv* env, jobject,
                                                         jlong jhandle) {
  auto* txn_db = reinterpret_cast<ROCKSDB_NAMESPACE::TransactionDB*>(jhandle);
 ...
 * Signature: (JI)V
 */
void Java_org_forstdb_TransactionDB_setDeadlockInfoBufferSize(
