...
#include "include/org_forstdb_CassandraValueMergeOperator.h"
 ...
 * Signature: (II)J
 */
jlong Java_org_forstdb_CassandraValueMergeOperator_newSharedCassandraValueMergeOperator(
 ...
 * Signature: (J)V
 */
void Java_org_forstdb_CassandraValueMergeOperator_disposeInternal(
