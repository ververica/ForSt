...
#include "include/org_forstdb_BloomFilter.h"
#include "include/org_forstdb_Filter.h"
 ...
 * Signature: (DZ)J
 */
jlong Java_org_forstdb_BloomFilter_createNewBloomFilter(JNIEnv* /*env*/,
                                                        jclass /*jcls*/,
 ...
 * Signature: (J)V
 */
void Java_org_forstdb_Filter_disposeInternal(JNIEnv* /*env*/, jobject /*jobj*/,
                                             jlong jhandle) {
  auto* handle =
