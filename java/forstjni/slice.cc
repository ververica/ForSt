...
#include "include/org_forstdb_AbstractSlice.h"
#include "include/org_forstdb_DirectSlice.h"
#include "include/org_forstdb_Slice.h"
 ...
 */
jlong Java_org_forstdb_AbstractSlice_createNewSliceFromString(JNIEnv* env,
                                                              jclass /*jcls*/,
                                                              jstring jstr) {
  ...
  // Java_org_forstdb_Slice_disposeInternalBuf or
  // or Java_org_forstdb_DirectSlice_disposeInternalBuf methods
 ...
 * Signature: (J)I
 */
jint Java_org_forstdb_AbstractSlice_size0(JNIEnv* /*env*/, jobject /*jobj*/,
                                          jlong handle) {
 ...
 * Signature: (J)Z
 */
jboolean Java_org_forstdb_AbstractSlice_empty0(JNIEnv* /*env*/,
 ...
 */
jstring Java_org_forstdb_AbstractSlice_toString0(JNIEnv* env, jobject /*jobj*/,
 ...
 * Signature: (JJ)I;
 */
jint Java_org_forstdb_AbstractSlice_compare0(JNIEnv* /*env*/, jobject /*jobj*/,
 ...
 * Signature: (JJ)Z;
 */
jboolean Java_org_forstdb_AbstractSlice_startsWith0(JNIEnv* /*env*/,
                                                    jobject /*jobj*/,
                                                    jlong handle,
                                                    jlong otherHandle) {
  const auto* slice = reinterpret_cast<ROCKSDB_NAMESPACE::Slice*>(handle);
 ...
 * Signature: (J)V
 */
void Java_org_forstdb_AbstractSlice_disposeInternal(JNIEnv* /*env*/,
                                                    jobject /*jobj*/,
                                                    jlong handle) {
 ...
 * Signature: ([BI)J
 */
jlong Java_org_forstdb_Slice_createNewSlice0(JNIEnv* env, jclass /*jcls*/,
                                             jbyteArray data, jint offset) {
  const jsize dataSize = env->GetArrayLength(data);
  const int len = dataSize - offset;

  // NOTE: buf will be deleted in the Java_org_forstdb_Slice_disposeInternalBuf
  // method
 ...
 * Signature: ([B)J
 */
jlong Java_org_forstdb_Slice_createNewSlice1(JNIEnv* env, jclass /*jcls*/,
                                             jbyteArray data) {
 ...
 * Signature: (J)[B
 */
jbyteArray Java_org_forstdb_Slice_data0(JNIEnv* env, jobject /*jobj*/,
                                        jlong handle) {
  const auto* slice = reinterpret_cast<ROCKSDB_NAMESPACE::Slice*>(handle);
 ...
 * Signature: (JZJ)V
 */
void Java_org_forstdb_Slice_clear0(JNIEnv* /*env*/, jobject /*jobj*/,
 ...
 * Signature: (JI)V
 */
void Java_org_forstdb_Slice_removePrefix0(JNIEnv* /*env*/, jobject /*jobj*/,
 ...
 * Signature: (JI)V
 */
void Java_org_forstdb_DirectSlice_setLength0(JNIEnv* /*env*/, jobject /*jobj*/,
                                             jlong handle, jint length) {
  auto* slice = reinterpret_cast<ROCKSDB_NAMESPACE::Slice*>(handle);
  slice->size_ = length;
}
 ...
 * Signature: (JJ)V
 */
void Java_org_forstdb_Slice_disposeInternalBuf(JNIEnv* /*env*/,
                                               jobject /*jobj*/, jlong handle,
                                               jlong internalBufferOffset) {
  const auto* slice = reinterpret_cast<ROCKSDB_NAMESPACE::Slice*>(handle);
  const char* buf = slice->data_ - internalBufferOffset;
 ...
 */
jlong Java_org_forstdb_DirectSlice_createNewDirectSlice0(JNIEnv* env,
                                                         jclass /*jcls*/,
                                                         jobject data,
                                                         jint length) {
  assert(data != nullptr);
 ...
 */
jlong Java_org_forstdb_DirectSlice_createNewDirectSlice1(JNIEnv* env,
                                                         jclass /*jcls*/,
                                                         jobject data) {
  void* data_addr = env->GetDirectBufferAddress(data);
  if (data_addr == nullptr) {
 ...
 */
jobject Java_org_forstdb_DirectSlice_data0(JNIEnv* env, jobject /*jobj*/,
                                           jlong handle) {
  const auto* slice = reinterpret_cast<ROCKSDB_NAMESPACE::Slice*>(handle);
 ...
 * Signature: (JI)B
 */
jbyte Java_org_forstdb_DirectSlice_get0(JNIEnv* /*env*/, jobject /*jobj*/,
 ...
 * Signature: (JZJ)V
 */
void Java_org_forstdb_DirectSlice_clear0(JNIEnv* /*env*/, jobject /*jobj*/,
                                         jlong handle, jboolean shouldRelease,
                                         jlong internalBufferOffset) {
  auto* slice = reinterpret_cast<ROCKSDB_NAMESPACE::Slice*>(handle);
  if (shouldRelease == JNI_TRUE) {
 ...
 * Signature: (JI)V
 */
void Java_org_forstdb_DirectSlice_removePrefix0(JNIEnv* /*env*/,
                                                jobject /*jobj*/, jlong handle,
                                                jint length) {
  auto* slice = reinterpret_cast<ROCKSDB_NAMESPACE::Slice*>(handle);
  slice->remove_prefix(length);
 ...
 * Signature: (JJ)V
 */
void Java_org_forstdb_DirectSlice_disposeInternalBuf(
