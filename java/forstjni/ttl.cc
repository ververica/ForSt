...
#include "include/org_forstdb_TtlDB.h"
 ...
 */
jlong Java_org_forstdb_TtlDB_open(JNIEnv* env, jclass, jlong joptions_handle,
 ...
 */
jlongArray Java_org_forstdb_TtlDB_openCF(JNIEnv* env, jclass, jlong jopt_handle,
                                         jstring jdb_path,
 ...
 * Signature: (J)V
 */
void Java_org_forstdb_TtlDB_disposeInternal(JNIEnv*, jobject, jlong jhandle) {
 ...
 * Signature: (J)V
 */
void Java_org_forstdb_TtlDB_closeDatabase(JNIEnv* /* env */, jclass,
                                          jlong /* jhandle */) {
  // auto* ttl_db = reinterpret_cast<ROCKSDB_NAMESPACE::DBWithTTL*>(jhandle);
  // assert(ttl_db != nullptr);
