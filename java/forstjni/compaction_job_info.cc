...
#include "include/org_forstdb_CompactionJobInfo.h"
 ...
 * Signature: ()J
 */
jlong Java_org_forstdb_CompactionJobInfo_newCompactionJobInfo(JNIEnv*, jclass) {
 ...
 * Signature: (J)V
 */
void Java_org_forstdb_CompactionJobInfo_disposeInternal(JNIEnv*, jobject,
                                                        jlong jhandle) {
 ...
 * Signature: (J)[B
 */
jbyteArray Java_org_forstdb_CompactionJobInfo_columnFamilyName(JNIEnv* env,
                                                               jclass,
                                                               jlong jhandle) {
  auto* compact_job_info =
      reinterpret_cast<ROCKSDB_NAMESPACE::CompactionJobInfo*>(jhandle);
 ...
 * Signature: (J)J
 */
jlong Java_org_forstdb_CompactionJobInfo_threadId(JNIEnv*, jclass,
                                                  jlong jhandle) {
  auto* compact_job_info =
      reinterpret_cast<ROCKSDB_NAMESPACE::CompactionJobInfo*>(jhandle);
 ...
 * Signature: (J)I
 */
jint Java_org_forstdb_CompactionJobInfo_jobId(JNIEnv*, jclass, jlong jhandle) {
  auto* compact_job_info =
      reinterpret_cast<ROCKSDB_NAMESPACE::CompactionJobInfo*>(jhandle);
 ...
 * Signature: (J)I
 */
jint Java_org_forstdb_CompactionJobInfo_baseInputLevel(JNIEnv*, jclass,
                                                       jlong jhandle) {
  auto* compact_job_info =
      reinterpret_cast<ROCKSDB_NAMESPACE::CompactionJobInfo*>(jhandle);
 ...
 * Signature: (J)I
 */
jint Java_org_forstdb_CompactionJobInfo_outputLevel(JNIEnv*, jclass,
                                                    jlong jhandle) {
  auto* compact_job_info =
      reinterpret_cast<ROCKSDB_NAMESPACE::CompactionJobInfo*>(jhandle);
 ...
 */
jobjectArray Java_org_forstdb_CompactionJobInfo_inputFiles(JNIEnv* env, jclass,
                                                           jlong jhandle) {
  auto* compact_job_info =
      reinterpret_cast<ROCKSDB_NAMESPACE::CompactionJobInfo*>(jhandle);
 ...
 * Signature: (J)[Ljava/lang/String;
 */
jobjectArray Java_org_forstdb_CompactionJobInfo_outputFiles(JNIEnv* env, jclass,
                                                            jlong jhandle) {
  auto* compact_job_info =
      reinterpret_cast<ROCKSDB_NAMESPACE::CompactionJobInfo*>(jhandle);
  return ROCKSDB_NAMESPACE::JniUtil::toJavaStrings(
 ...
 */
jobject Java_org_forstdb_CompactionJobInfo_tableProperties(JNIEnv* env, jclass,
                                                           jlong jhandle) {
  auto* compact_job_info =
      reinterpret_cast<ROCKSDB_NAMESPACE::CompactionJobInfo*>(jhandle);
 ...
 * Signature: (J)B
 */
jbyte Java_org_forstdb_CompactionJobInfo_compactionReason(JNIEnv*, jclass,
                                                          jlong jhandle) {
  auto* compact_job_info =
      reinterpret_cast<ROCKSDB_NAMESPACE::CompactionJobInfo*>(jhandle);
 ...
 * Signature: (J)B
 */
jbyte Java_org_forstdb_CompactionJobInfo_compression(JNIEnv*, jclass,
                                                     jlong jhandle) {
  auto* compact_job_info =
      reinterpret_cast<ROCKSDB_NAMESPACE::CompactionJobInfo*>(jhandle);
 ...
 * Signature: (J)J
 */
jlong Java_org_forstdb_CompactionJobInfo_stats(JNIEnv*, jclass, jlong jhandle) {
  auto* compact_job_info =
      reinterpret_cast<ROCKSDB_NAMESPACE::CompactionJobInfo*>(jhandle);
