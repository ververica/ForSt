...
#include "include/org_forstdb_CompactionOptions.h"
 ...
 * Signature: ()J
 */
jlong Java_org_forstdb_CompactionOptions_newCompactionOptions(JNIEnv*, jclass) {
 ...
 * Signature: (J)V
 */
void Java_org_forstdb_CompactionOptions_disposeInternal(JNIEnv*, jobject,
                                                        jlong jhandle) {
  auto* compact_opts =
 ...
 * Signature: (J)B
 */
jbyte Java_org_forstdb_CompactionOptions_compression(JNIEnv*, jclass,
                                                     jlong jhandle) {
  auto* compact_opts =
      reinterpret_cast<ROCKSDB_NAMESPACE::CompactionOptions*>(jhandle);
 ...
 * Signature: (JB)V
 */
void Java_org_forstdb_CompactionOptions_setCompression(
 ...
 * Signature: (J)J
 */
jlong Java_org_forstdb_CompactionOptions_outputFileSizeLimit(JNIEnv*, jclass,
                                                             jlong jhandle) {
  auto* compact_opts =
      reinterpret_cast<ROCKSDB_NAMESPACE::CompactionOptions*>(jhandle);
 ...
 * Signature: (JJ)V
 */
void Java_org_forstdb_CompactionOptions_setOutputFileSizeLimit(
 ...
 * Signature: (J)I
 */
jint Java_org_forstdb_CompactionOptions_maxSubcompactions(JNIEnv*, jclass,
                                                          jlong jhandle) {
  auto* compact_opts =
      reinterpret_cast<ROCKSDB_NAMESPACE::CompactionOptions*>(jhandle);
 ...
 * Signature: (JI)V
 */
void Java_org_forstdb_CompactionOptions_setMaxSubcompactions(
