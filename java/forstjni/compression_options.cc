...
#include "include/org_forstdb_CompressionOptions.h"
 ...
 * Signature: ()J
 */
jlong Java_org_forstdb_CompressionOptions_newCompressionOptions(JNIEnv*,
                                                                jclass) {
 ...
 * Signature: (JI)V
 */
void Java_org_forstdb_CompressionOptions_setWindowBits(JNIEnv*, jobject,
                                                       jlong jhandle,
                                                       jint jwindow_bits) {
 ...
 * Signature: (J)I
 */
jint Java_org_forstdb_CompressionOptions_windowBits(JNIEnv*, jobject,
                                                    jlong jhandle) {
  auto* opt = reinterpret_cast<ROCKSDB_NAMESPACE::CompressionOptions*>(jhandle);
 ...
 * Signature: (JI)V
 */
void Java_org_forstdb_CompressionOptions_setLevel(JNIEnv*, jobject,
 ...
 * Signature: (J)I
 */
jint Java_org_forstdb_CompressionOptions_level(JNIEnv*, jobject,
                                               jlong jhandle) {
  auto* opt = reinterpret_cast<ROCKSDB_NAMESPACE::CompressionOptions*>(jhandle);
 ...
 * Signature: (JI)V
 */
void Java_org_forstdb_CompressionOptions_setStrategy(JNIEnv*, jobject,
                                                     jlong jhandle,
                                                     jint jstrategy) {
  auto* opt = reinterpret_cast<ROCKSDB_NAMESPACE::CompressionOptions*>(jhandle);
 ...
 * Signature: (J)I
 */
jint Java_org_forstdb_CompressionOptions_strategy(JNIEnv*, jobject,
                                                  jlong jhandle) {
  auto* opt = reinterpret_cast<ROCKSDB_NAMESPACE::CompressionOptions*>(jhandle);
 ...
 * Signature: (JI)V
 */
void Java_org_forstdb_CompressionOptions_setMaxDictBytes(JNIEnv*, jobject,
                                                         jlong jhandle,
 ...
 * Signature: (J)I
 */
jint Java_org_forstdb_CompressionOptions_maxDictBytes(JNIEnv*, jobject,
                                                      jlong jhandle) {
  auto* opt = reinterpret_cast<ROCKSDB_NAMESPACE::CompressionOptions*>(jhandle);
 ...
 * Signature: (JI)V
 */
void Java_org_forstdb_CompressionOptions_setZstdMaxTrainBytes(
 ...
 * Signature: (J)I
 */
jint Java_org_forstdb_CompressionOptions_zstdMaxTrainBytes(JNIEnv*, jobject,
                                                           jlong jhandle) {
  auto* opt = reinterpret_cast<ROCKSDB_NAMESPACE::CompressionOptions*>(jhandle);
 ...
 * Signature: (JJ)V
 */
void Java_org_forstdb_CompressionOptions_setMaxDictBufferBytes(
 ...
 * Signature: (J)J
 */
jlong Java_org_forstdb_CompressionOptions_maxDictBufferBytes(JNIEnv*, jobject,
                                                             jlong jhandle) {
  auto* opt = reinterpret_cast<ROCKSDB_NAMESPACE::CompressionOptions*>(jhandle);
 ...
 * Signature: (JZ)V
 */
void Java_org_forstdb_CompressionOptions_setUseZstdDictTrainer(
 ...
 * Signature: (J)Z
 */
jboolean Java_org_forstdb_CompressionOptions_useZstdDictTrainer(JNIEnv*,
                                                                jobject,
                                                                jlong jhandle) {
  auto* opt = reinterpret_cast<ROCKSDB_NAMESPACE::CompressionOptions*>(jhandle);
 ...
 * Signature: (JZ)V
 */
void Java_org_forstdb_CompressionOptions_setEnabled(JNIEnv*, jobject,
                                                    jlong jhandle,
                                                    jboolean jenabled) {
  auto* opt = reinterpret_cast<ROCKSDB_NAMESPACE::CompressionOptions*>(jhandle);
 ...
 * Signature: (J)Z
 */
jboolean Java_org_forstdb_CompressionOptions_enabled(JNIEnv*, jobject,
                                                     jlong jhandle) {
  auto* opt = reinterpret_cast<ROCKSDB_NAMESPACE::CompressionOptions*>(jhandle);
 ...
 * Signature: (J)V
 */
void Java_org_forstdb_CompressionOptions_disposeInternal(JNIEnv*, jobject,
                                                         jlong jhandle) {
