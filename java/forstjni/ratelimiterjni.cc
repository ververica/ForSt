...
#include "include/org_forstdb_RateLimiter.h"
 ...
 * Signature: (JJIBZ)J
 */
jlong Java_org_forstdb_RateLimiter_newRateLimiterHandle(
 ...
 * Signature: (J)V
 */
void Java_org_forstdb_RateLimiter_disposeInternal(JNIEnv* /*env*/,
                                                  jobject /*jobj*/,
                                                  jlong jhandle) {
  auto* handle =
 ...
 * Signature: (JJ)V
 */
void Java_org_forstdb_RateLimiter_setBytesPerSecond(JNIEnv* /*env*/,
                                                    jobject /*jobj*/,
                                                    jlong handle,
 ...
 * Signature: (J)J
 */
jlong Java_org_forstdb_RateLimiter_getBytesPerSecond(JNIEnv* /*env*/,
                                                     jobject /*jobj*/,
                                                     jlong handle) {
 ...
 * Signature: (JJ)V
 */
void Java_org_forstdb_RateLimiter_request(JNIEnv* /*env*/, jobject /*jobj*/,
 ...
 * Signature: (J)J
 */
jlong Java_org_forstdb_RateLimiter_getSingleBurstBytes(JNIEnv* /*env*/,
                                                       jobject /*jobj*/,
                                                       jlong handle) {
  return reinterpret_cast<std::shared_ptr<ROCKSDB_NAMESPACE::RateLimiter>*>(
             handle)
 ...
 * Signature: (J)J
 */
jlong Java_org_forstdb_RateLimiter_getTotalBytesThrough(JNIEnv* /*env*/,
                                                        jobject /*jobj*/,
                                                        jlong handle) {
  return reinterpret_cast<std::shared_ptr<ROCKSDB_NAMESPACE::RateLimiter>*>(
             handle)
 ...
 * Signature: (J)J
 */
jlong Java_org_forstdb_RateLimiter_getTotalRequests(JNIEnv* /*env*/,
                                                    jobject /*jobj*/,
                                                    jlong handle) {
  return reinterpret_cast<std::shared_ptr<ROCKSDB_NAMESPACE::RateLimiter>*>(
             handle)
