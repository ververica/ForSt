...
#include "include/org_forstdb_BackupEngine.h"
 ...
 * Signature: (JJ)J
 */
jlong Java_org_forstdb_BackupEngine_open(JNIEnv* env, jclass /*jcls*/,
                                         jlong env_handle,
 ...
 * Signature: (JJZ)V
 */
void Java_org_forstdb_BackupEngine_createNewBackup(
 ...
 */
void Java_org_forstdb_BackupEngine_createNewBackupWithMetadata(
    JNIEnv* env, jobject /*jbe*/, jlong jbe_handle, jlong db_handle,
 ...
 */
jobject Java_org_forstdb_BackupEngine_getBackupInfo(JNIEnv* env,
                                                    jobject /*jbe*/,
                                                    jlong jbe_handle) {
  auto* backup_engine =
      reinterpret_cast<ROCKSDB_NAMESPACE::BackupEngine*>(jbe_handle);
 ...
 * Signature: (J)[I
 */
jintArray Java_org_forstdb_BackupEngine_getCorruptedBackups(JNIEnv* env,
                                                            jobject /*jbe*/,
                                                            jlong jbe_handle) {
  auto* backup_engine =
      reinterpret_cast<ROCKSDB_NAMESPACE::BackupEngine*>(jbe_handle);
 ...
 * Signature: (J)V
 */
void Java_org_forstdb_BackupEngine_garbageCollect(JNIEnv* env, jobject /*jbe*/,
                                                  jlong jbe_handle) {
  auto* backup_engine =
      reinterpret_cast<ROCKSDB_NAMESPACE::BackupEngine*>(jbe_handle);
 ...
 * Signature: (JI)V
 */
void Java_org_forstdb_BackupEngine_purgeOldBackups(JNIEnv* env, jobject /*jbe*/,
                                                   jlong jbe_handle,
 ...
 * Signature: (JI)V
 */
void Java_org_forstdb_BackupEngine_deleteBackup(JNIEnv* env, jobject /*jbe*/,
                                                jlong jbe_handle,
                                                jint jbackup_id) {
  auto* backup_engine =
      reinterpret_cast<ROCKSDB_NAMESPACE::BackupEngine*>(jbe_handle);
 ...
 */
void Java_org_forstdb_BackupEngine_restoreDbFromBackup(
 ...
 */
void Java_org_forstdb_BackupEngine_restoreDbFromLatestBackup(
 ...
 * Signature: (J)V
 */
void Java_org_forstdb_BackupEngine_disposeInternal(JNIEnv* /*env*/,
                                                   jobject /*jbe*/,
                                                   jlong jbe_handle) {
