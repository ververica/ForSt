...
#include "include/org_forstdb_Env.h"
#include "include/org_forstdb_RocksEnv.h"
#include "include/org_forstdb_RocksMemEnv.h"
#include "include/org_forstdb_TimedEnv.h"
#include "portal.h"
 ...
 * Signature: ()J
 */
jlong Java_org_forstdb_Env_getDefaultEnvInternal(JNIEnv*, jclass) {
 ...
 * Signature: (J)V
 */
void Java_org_forstdb_RocksEnv_disposeInternal(JNIEnv*, jobject,
                                               jlong jhandle) {
 ...
 * Signature: (JIB)V
 */
void Java_org_forstdb_Env_setBackgroundThreads(JNIEnv*, jobject, jlong jhandle,
                                               jint jnum,
 ...
 * Signature: (JB)I
 */
jint Java_org_forstdb_Env_getBackgroundThreads(JNIEnv*, jobject, jlong jhandle,
                                               jbyte jpriority_value) {
  auto* rocks_env = reinterpret_cast<ROCKSDB_NAMESPACE::Env*>(jhandle);
 ...
 * Signature: (JB)I
 */
jint Java_org_forstdb_Env_getThreadPoolQueueLen(JNIEnv*, jobject, jlong jhandle,
                                                jbyte jpriority_value) {
  auto* rocks_env = reinterpret_cast<ROCKSDB_NAMESPACE::Env*>(jhandle);
 ...
 * Signature: (JIB)V
 */
void Java_org_forstdb_Env_incBackgroundThreadsIfNeeded(JNIEnv*, jobject,
 ...
 * Signature: (JB)V
 */
void Java_org_forstdb_Env_lowerThreadPoolIOPriority(JNIEnv*, jobject,
                                                    jlong jhandle,
                                                    jbyte jpriority_value) {
  auto* rocks_env = reinterpret_cast<ROCKSDB_NAMESPACE::Env*>(jhandle);
 ...
 * Signature: (JB)V
 */
void Java_org_forstdb_Env_lowerThreadPoolCPUPriority(JNIEnv*, jobject,
                                                     jlong jhandle,
                                                     jbyte jpriority_value) {
  auto* rocks_env = reinterpret_cast<ROCKSDB_NAMESPACE::Env*>(jhandle);
 ...
 * Signature: (J)J
 */
jlong Java_org_forstdb_RocksMemEnv_createMemEnv(JNIEnv*, jclass,
 ...
 * Signature: (J)V
 */
void Java_org_forstdb_RocksMemEnv_disposeInternal(JNIEnv*, jobject,
                                                  jlong jhandle) {
  auto* e = reinterpret_cast<ROCKSDB_NAMESPACE::Env*>(jhandle);
  assert(e != nullptr);
  delete e;
 ...
 * Signature: (J)J
 */
jlong Java_org_forstdb_TimedEnv_createTimedEnv(JNIEnv*, jclass,
                                               jlong jbase_env_handle) {
  auto* base_env = reinterpret_cast<ROCKSDB_NAMESPACE::Env*>(jbase_env_handle);
 ...
 * Signature: (J)V
 */
void Java_org_forstdb_TimedEnv_disposeInternal(JNIEnv*, jobject,
                                               jlong jhandle) {
  auto* e = reinterpret_cast<ROCKSDB_NAMESPACE::Env*>(jhandle);
  assert(e != nullptr);
  delete e;
