...
#include "include/org_forstdb_CompactionOptionsFIFO.h"
 ...
 * Signature: ()J
 */
jlong Java_org_forstdb_CompactionOptionsFIFO_newCompactionOptionsFIFO(JNIEnv*,
                                                                      jclass) {
 ...
 * Signature: (JJ)V
 */
void Java_org_forstdb_CompactionOptionsFIFO_setMaxTableFilesSize(
 ...
 * Signature: (J)J
 */
jlong Java_org_forstdb_CompactionOptionsFIFO_maxTableFilesSize(JNIEnv*, jobject,
                                                               jlong jhandle) {
  auto* opt =
      reinterpret_cast<ROCKSDB_NAMESPACE::CompactionOptionsFIFO*>(jhandle);
 ...
 * Signature: (JZ)V
 */
void Java_org_forstdb_CompactionOptionsFIFO_setAllowCompaction(
 ...
 * Signature: (J)Z
 */
jboolean Java_org_forstdb_CompactionOptionsFIFO_allowCompaction(JNIEnv*,
                                                                jobject,
                                                                jlong jhandle) {
  auto* opt =
      reinterpret_cast<ROCKSDB_NAMESPACE::CompactionOptionsFIFO*>(jhandle);
 ...
 * Signature: (J)V
 */
void Java_org_forstdb_CompactionOptionsFIFO_disposeInternal(JNIEnv*, jobject,
                                                            jlong jhandle) {
