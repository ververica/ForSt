...
#include "include/org_forstdb_OptimisticTransactionDB.h"
 ...
 */
jlongArray
Java_org_forstdb_OptimisticTransactionDB_open__JLjava_lang_String_2_3_3B_3J(
 ...
 * Signature: (J)V
 */
void Java_org_forstdb_OptimisticTransactionDB_disposeInternal(JNIEnv*, jobject,
                                                              jlong jhandle) {
 ...
 * Signature: (J)V
 */
void Java_org_forstdb_OptimisticTransactionDB_closeDatabase(JNIEnv* env, jclass,
                                                            jlong jhandle) {
  auto* optimistic_txn_db =
      reinterpret_cast<ROCKSDB_NAMESPACE::OptimisticTransactionDB*>(jhandle);
  assert(optimistic_txn_db != nullptr);
 ...
 * Signature: (JJ)J
 */
jlong Java_org_forstdb_OptimisticTransactionDB_beginTransaction__JJ(
 ...
 * Signature: (J)J
 */
jlong Java_org_forstdb_OptimisticTransactionDB_getBaseDB(JNIEnv*, jobject,
                                                         jlong jhandle) {
  auto* optimistic_txn_db =
      reinterpret_cast<ROCKSDB_NAMESPACE::OptimisticTransactionDB*>(jhandle);
