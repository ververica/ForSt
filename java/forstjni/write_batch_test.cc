...
#include "include/org_forstdb_WriteBatchTest.h"
#include "include/org_forstdb_WriteBatchTestInternalHelper.h"
 ...
 * Signature: (J)[B
 */
jbyteArray Java_org_forstdb_WriteBatchTest_getContents(JNIEnv* env,
                                                       jclass /*jclazz*/,
                                                       jlong jwb_handle) {
 ...
 * Signature: (JJ)V
 */
void Java_org_forstdb_WriteBatchTestInternalHelper_setSequence(
 ...
 * Signature: (J)J
 */
jlong Java_org_forstdb_WriteBatchTestInternalHelper_sequence(JNIEnv* /*env*/,
                                                             jclass /*jclazz*/,
                                                             jlong jwb_handle) {
  auto* wb = reinterpret_cast<ROCKSDB_NAMESPACE::WriteBatch*>(jwb_handle);
  assert(wb != nullptr);
 ...
 * Signature: (JJ)V
 */
void Java_org_forstdb_WriteBatchTestInternalHelper_append(JNIEnv* /*env*/,
                                                          jclass /*jclazz*/,
                                                          jlong jwb_handle_1,
                                                          jlong jwb_handle_2) {
