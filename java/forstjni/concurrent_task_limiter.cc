...
#include "include/org_forstdb_ConcurrentTaskLimiterImpl.h"
 ...
 */
jlong Java_org_forstdb_ConcurrentTaskLimiterImpl_newConcurrentTaskLimiterImpl0(
 ...
 */
jstring Java_org_forstdb_ConcurrentTaskLimiterImpl_name(JNIEnv* env, jclass,
                                                        jlong handle) {
 ...
 * Signature: (JI)V
 */
void Java_org_forstdb_ConcurrentTaskLimiterImpl_setMaxOutstandingTask(
 ...
 * Signature: (J)I
 */
jint Java_org_forstdb_ConcurrentTaskLimiterImpl_outstandingTask(JNIEnv*, jclass,
                                                                jlong handle) {
  const auto& limiter = *reinterpret_cast<
      std::shared_ptr<ROCKSDB_NAMESPACE::ConcurrentTaskLimiter>*>(handle);
 ...
 * Signature: (J)V
 */
void Java_org_forstdb_ConcurrentTaskLimiterImpl_disposeInternal(JNIEnv*,
                                                                jobject,
                                                                jlong jhandle) {
