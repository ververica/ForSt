...
#include "include/org_forstdb_SstFileManager.h"
 ...
 * Signature: (JJJDJ)J
 */
jlong Java_org_forstdb_SstFileManager_newSstFileManager(
 ...
 * Signature: (JJ)V
 */
void Java_org_forstdb_SstFileManager_setMaxAllowedSpaceUsage(
 ...
 * Signature: (JJ)V
 */
void Java_org_forstdb_SstFileManager_setCompactionBufferSize(
    JNIEnv* /*env*/, jobject /*jobj*/, jlong jhandle,
 ...
 * Signature: (J)Z
 */
jboolean Java_org_forstdb_SstFileManager_isMaxAllowedSpaceReached(
    JNIEnv* /*env*/, jobject /*jobj*/, jlong jhandle) {
  auto* sptr_sst_file_manager =
      reinterpret_cast<std::shared_ptr<ROCKSDB_NAMESPACE::SstFileManager>*>(
          jhandle);
 ...
 */
jboolean
Java_org_forstdb_SstFileManager_isMaxAllowedSpaceReachedIncludingCompactions(
    JNIEnv* /*env*/, jobject /*jobj*/, jlong jhandle) {
  auto* sptr_sst_file_manager =
      reinterpret_cast<std::shared_ptr<ROCKSDB_NAMESPACE::SstFileManager>*>(
          jhandle);
 ...
 * Signature: (J)J
 */
jlong Java_org_forstdb_SstFileManager_getTotalSize(JNIEnv* /*env*/,
                                                   jobject /*jobj*/,
                                                   jlong jhandle) {
  auto* sptr_sst_file_manager =
      reinterpret_cast<std::shared_ptr<ROCKSDB_NAMESPACE::SstFileManager>*>(
 ...
 */
jobject Java_org_forstdb_SstFileManager_getTrackedFiles(JNIEnv* env,
                                                        jobject /*jobj*/,
                                                        jlong jhandle) {
  auto* sptr_sst_file_manager =
      reinterpret_cast<std::shared_ptr<ROCKSDB_NAMESPACE::SstFileManager>*>(
 ...
 * Signature: (J)J
 */
jlong Java_org_forstdb_SstFileManager_getDeleteRateBytesPerSecond(
    JNIEnv* /*env*/, jobject /*jobj*/, jlong jhandle) {
  auto* sptr_sst_file_manager =
      reinterpret_cast<std::shared_ptr<ROCKSDB_NAMESPACE::SstFileManager>*>(
          jhandle);
 ...
 * Signature: (JJ)V
 */
void Java_org_forstdb_SstFileManager_setDeleteRateBytesPerSecond(
 ...
 * Signature: (J)D
 */
jdouble Java_org_forstdb_SstFileManager_getMaxTrashDBRatio(JNIEnv* /*env*/,
                                                           jobject /*jobj*/,
                                                           jlong jhandle) {
  auto* sptr_sst_file_manager =
      reinterpret_cast<std::shared_ptr<ROCKSDB_NAMESPACE::SstFileManager>*>(
 ...
 * Signature: (JD)V
 */
void Java_org_forstdb_SstFileManager_setMaxTrashDBRatio(JNIEnv* /*env*/,
                                                        jobject /*jobj*/,
                                                        jlong jhandle,
                                                        jdouble jratio) {
  auto* sptr_sst_file_manager =
 ...
 * Signature: (J)V
 */
void Java_org_forstdb_SstFileManager_disposeInternal(JNIEnv* /*env*/,
                                                     jobject /*jobj*/,
                                                     jlong jhandle) {
  auto* sptr_sst_file_manager =
      reinterpret_cast<std::shared_ptr<ROCKSDB_NAMESPACE::SstFileManager>*>(
