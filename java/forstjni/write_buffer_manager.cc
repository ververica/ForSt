...
#include "include/org_forstdb_WriteBufferManager.h"
 ...
 * Signature: (JJ)J
 */
jlong Java_org_forstdb_WriteBufferManager_newWriteBufferManager(
 ...
 * Signature: (J)V
 */
void Java_org_forstdb_WriteBufferManager_disposeInternal(JNIEnv* /*env*/,
                                                         jobject /*jobj*/,
                                                         jlong jhandle) {
  auto* write_buffer_manager =
