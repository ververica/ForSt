...
#include "include/org_forstdb_RemoveEmptyValueCompactionFilter.h"
 ...
 * Signature: ()J
 */
jlong Java_org_forstdb_RemoveEmptyValueCompactionFilter_createNewRemoveEmptyValueCompactionFilter0(
