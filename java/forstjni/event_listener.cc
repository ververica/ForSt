...
#include "include/org_forstdb_AbstractEventListener.h"
 ...
 * Signature: (J)J
 */
jlong Java_org_forstdb_AbstractEventListener_createNewEventListener(
 ...
 * Signature: (J)V
 */
void Java_org_forstdb_AbstractEventListener_disposeInternal(JNIEnv*, jobject,
                                                            jlong jhandle) {
