...
#include "include/org_forstdb_Cache.h"
 ...
 * Signature: (J)J
 */
jlong Java_org_forstdb_Cache_getUsage(JNIEnv*, jclass, jlong jhandle) {
  auto* sptr_cache =
 ...
 * Signature: (J)J
 */
jlong Java_org_forstdb_Cache_getPinnedUsage(JNIEnv*, jclass, jlong jhandle) {
  auto* sptr_cache =
      reinterpret_cast<std::shared_ptr<ROCKSDB_NAMESPACE::Cache>*>(jhandle);
