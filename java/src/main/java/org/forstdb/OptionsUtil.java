...
public class OptionsUtil {
   ...
   * @param configOptions {@link org.forstdb.ConfigOptions} instance.
   * @param dbOptions {@link org.forstdb.DBOptions} instance. This will be
   *     filled and returned.
   * @param cfDescs A list of {@link org.forstdb.ColumnFamilyDescriptor}'s be
   *     returned.
   ...
   *
   * @param dbPath the path to the RocksDB.
   * @param env {@link org.forstdb.Env} instance.
