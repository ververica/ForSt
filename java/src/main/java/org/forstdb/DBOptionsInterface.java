...
public interface DBOptionsInterface<T extends DBOptionsInterface<T>> {
   ...
   *     specified database in {@link RocksDB#open(org.forstdb.Options, String)} operation
   *     is missing.
   * @return the instance of the current Options
   * @see RocksDB#open(org.forstdb.Options, String)
   */
   ...
   * Default: nullptr
   *
   * @param rateLimiter {@link org.forstdb.RateLimiter} instance.
   * @return the instance of the current object.
   *
   * @since 3.10.0
   */
