 ...
 *   @see org.forstdb.Slice
 *   @see org.forstdb.DirectSlice
 *
 ...
 *   @see org.forstdb.AbstractSlice subclass Objects. When you dispose
 *   the Java @see org.forstdb.AbstractComparator subclass, it disposes the
 *   C++ BaseComparatorJniCallback subclass, which in turn destroys the
 *   Java @see org.forstdb.AbstractSlice subclass Objects.
 */
public abstract class AbstractSlice<T> extends RocksMutableObject {
   ...
   *   @see org.forstdb.AbstractSlice#data0(long)
   */
  public T data() {
