...
public class WBWIRocksIterator
   ...
   * {@link org.forstdb.WBWIRocksIterator#entry()}
   *
   * It is worth noting that a WriteEntry with
   * the type {@link org.forstdb.WBWIRocksIterator.WriteType#DELETE}
   * or {@link org.forstdb.WBWIRocksIterator.WriteType#LOG}
  ...
  public static class WriteEntry implements AutoCloseable {
     ...
     * by calling {@link org.forstdb.WBWIRocksIterator#entry()}
     */
    private WriteEntry() {
      key = new DirectSlice();
