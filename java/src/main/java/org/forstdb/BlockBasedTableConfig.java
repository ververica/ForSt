...
public class BlockBasedTableConfig extends TableFormatConfig {
   ...
   *
   * @param indexType {@link org.forstdb.IndexType} value
   ...
   *
   * @param dataBlockIndexType {@link org.forstdb.DataBlockIndexType} value
   * @return the reference to the current option.
   */
   ...
   * Sets
   *
   * @param checksumType {@link org.forstdb.ChecksumType} value.
   * @return the reference to the current option.
   */
   ...
   * <p>
   * {@link org.forstdb.Cache} should not be disposed before options instances
   * using this cache is disposed.
   * <p>
   * {@link org.forstdb.Cache} instance can be re-used in multiple options
   * instances.
   *
   * @param blockCache {@link org.forstdb.Cache} Cache java instance
   *     (e.g. LRUCache).
   *
   * @return the reference to the current config.
   */
   ...
   * <p>
   * {@link org.forstdb.Filter} should not be closed before options instances
   * using this filter are closed.
   * <p>
   * {@link org.forstdb.Filter} instance can be re-used in multiple options
   * instances.
   *
   * @param filterPolicy {@link org.forstdb.Filter} Filter Policy java instance.
   * @return the reference to the current config.
   */
