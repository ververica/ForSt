...
public class LocalFileSystem extends FileSystem {
  ...
  @Override
  public InputStream open(final Path f, final int bufferSize) throws IOException {
    return open(f);
  }

  @Override
  public InputStream open(final Path f) throws IOException {
  ...
  @Override
  public OutputStream create(final Path filePath, final WriteMode overwrite) throws IOException {
  ...
  public boolean rename(final Path src, final Path dst) throws IOException {
    ...
    try {
      ...
      return true;
    } catch (NoSuchFileException | AccessDeniedException | DirectoryNotEmptyException
